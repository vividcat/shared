 ...
 * 将十六进制颜色转换成 Rgb 对象
 *
 * **注意：如需要着重处理色彩，请使用合适的色彩库**
 *
 * @param color 十六进制颜色，如(#000|#ffffff)，不支持透明度，如(#0000|#ffffff80)
 * @returns 非支持色彩将转换成白色
 */
...
/**
 * 将十六进制的颜色转换成 Rgba 字符串
 *
 * **注意：如需要着重处理色彩，请使用合适的色彩库**
 *
 * @param color 十六进制颜色，不支持透明度（`#000`，`#ffffff`，而不是 `#0000`，`#ffffff80`）
 * @param alpha 0 - 1 之间
 * @returns 非支持色彩将转换成白色
 */
...
/**
* 将色彩字符串或者十六进制颜色转换成 Rgba 字符串
 *
 * **注意：如需要着重处理色彩，请使用合适的色彩库**
 *
 * @param color 预留色彩 {@link Alias} 字符串或者十六进制颜色，不支持透明度（`#000`，`#ffffff`，而不是 `#0000`，`#ffffff80`）
 * @param alpha 0 - 1 之间
 * @returns 非支持色彩将转换成白色
 */
